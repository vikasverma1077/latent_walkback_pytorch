...
def train(args,
    ...
    train_loader, test_loader, extra_loader, num_classes = load_data(args.data_aug, batch_size= args.batch_size ,workers=2, dataset=dataset, data_target_dir= '/u/goyalani/data/DARC/svhn')
    #n_colors = 3
    spatial_width = 32
