...
class Net(nn.Module):
    def __init__(self, args,input_shape=(1,hw_size,hw_size)):
        ...
        self.fc_x_z_1 = nn.Linear(784, 600)
        ...
        self.fc_z_x_1 = nn.Linear(args.nl, 600)
...
def train(args,
    ...
    print 'loading mnist'
    train_loader, test_loader=load_mnist(data_aug=0, batch_size =100, test_batch_size =100 ,cuda= True, data_target_dir= "/u/vermavik/DARC/mnist")
        ...
        #    batch_idx +=1 
            ...
            if batch_idx%100==0:
                ...
                for num_step in range(args.num_steps * args.meta_steps):
                    ...
                    data_ = data_forward_diffusion.view(-1,1, spatial_width, spatial_width)#reshape(args.batch_size, n_colors, WIDTH, WIDTH)
                    if num_step%2==1:
                        plot_images(data_.data.cpu().numpy(), model_dir + '/' + "batch_" + str(batch_idx) + '_corrupted_' + 'epoch_' + str(epoch) + '_time_step_' + str(num_step))
